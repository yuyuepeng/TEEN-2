...
- (id)initWithView:(UIView *)contentview parentView:(UIView *)parentview
{
    ...
    //视图控制器View的大小 正常情况下应该是与屏幕一样大小,如果加在了容器视图控制上, 可能发生改变
    self = [super initWithFrame:CGRectMake(0,0,KscreenWidth, KscreenHeight)];//设置一下控制器视图的大小.
...
//        [self addGestureRecognizer:tapGestureRecognizer];
        ...
        _leftCenter = CGPointMake(self.frame.size.width*1.5, self.parentView.center.y);
        _rightCenter = CGPointMake(self.frame.size.width/2 + 100, self.parentView.center.y);
        self.center = _leftCenter;//默认显示左边
